...
<div class="container">
    ...
    <form id="createRoleForm" action="/role/createRole" method="POST">
        <label>Name:</label>
        ...
        <button type="submit" id="submitBtn">Crear Rol</button>
    </form>
</div>
...
document.getElementById('createRoleForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (response.ok && result.status === 201) {
            ...
            showMessage('error', result.message || 'Error al crear el rol');
