    ...
    document.getElementById('changePasswordForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            try {
                ...
                result.message = "El servidor devolvió una respuesta no válida";
            }
            ...
            if (response.ok && result.status === 200) {
                ...
                // Mostrar mensaje con detalle del 400
                const msg = result.message || `Error ${response.status}: ${response.statusText}`;
